...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get(
        # "DATABASE_URL", "https://aset.api.insaba.co.id/" + os.path.join(basedir, "data-dev.sqlite")
        # "DATABASE_URL", "https://aset.api.insaba.co.id/" + os.path.join(basedir, "data-dev.sqlite")
...
class ProductionConfig(Config):
    DEBUG = False
    SQLALCHEMY_DATABASE_URI = os.environ.get(
        # "DATABASE_URL", "https://aset.api.insaba.co.id/" + os.path.join(basedir, "data.sqlite")
