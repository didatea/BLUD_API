...
from app import db
from . import searchField, uniqueField, sortField, crudTitle, respAnTBPyloadFields, modelName, filterField
from .doc import doc
...
class Service:
    ...
    @staticmethod
    def getDataAll(args):
        return GeneralGetDataAll(respAnTBPyloadFields, model, current_app, args, filterField)

    @staticmethod
    def getDataServerSide(args):
        return GeneralGetDataServerSide(model, searchField, respAnTBPyloadFields, sortField, db, current_app, args, filterField)
