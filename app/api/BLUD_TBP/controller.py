...
from . import crudTitle, enableTBPgination, respAnTBPyloadFields, fileFields, modelName, filterField
from .doc import doc
...
class List(Resource):
    ...
    if 'parent_id' in respAnTBPyloadFields:
    ...
    @token_required
    def get(self):
        return GeneralGetList(doc, crudTitle, enableTBPgination, respAnTBPyloadFields, Service, parser)
