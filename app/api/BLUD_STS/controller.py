...
from . import crudTitle, enableSTSgination, respAnSTSyloadFields, fileFields, modelName, filterField
from .doc import doc
...
class List(Resource):
    ...
    if 'parent_id' in respAnSTSyloadFields:
    ...
    @token_required
    def get(self):
        return GeneralGetList(doc, crudTitle, enableSTSgination, respAnSTSyloadFields, Service, parser)
