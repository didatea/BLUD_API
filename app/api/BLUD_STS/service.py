...
from app import db
from . import searchField, uniqueField, sortField, crudTitle, respAnSTSyloadFields, modelName, filterField
from .doc import doc
...
class Service:
    ...
    @staticmethod
    def getDataAll(args):
        return GeneralGetDataAll(respAnSTSyloadFields, model, current_app, args, filterField)

    @staticmethod
    def getDataServerSide(args):
        return GeneralGetDataServerSide(model, searchField, respAnSTSyloadFields, sortField, db, current_app, args, filterField)
