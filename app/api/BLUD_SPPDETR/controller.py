...
from . import crudTitle, enableSPPDETRgination, respAnSPPDETRyloadFields, fileFields, modelName, filterField
from .doc import doc
...
class List(Resource):
    ...
    if 'parent_id' in respAnSPPDETRyloadFields:
    ...
    @token_required
    def get(self):
        return GeneralGetList(doc, crudTitle, enableSPPDETRgination, respAnSPPDETRyloadFields, Service, parser)
