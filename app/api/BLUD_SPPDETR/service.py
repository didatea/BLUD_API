...
from app import db
from . import searchField, uniqueField, sortField, crudTitle, respAnSPPDETRyloadFields, modelName, filterField
from .doc import doc
...
class Service:
    ...
    @staticmethod
    def getDataAll(args):
        return GeneralGetDataAll(respAnSPPDETRyloadFields, model, current_app, args, filterField)

    @staticmethod
    def getDataServerSide(args):
        return GeneralGetDataServerSide(model, searchField, respAnSPPDETRyloadFields, sortField, db, current_app, args, filterField)
