...
from . import crudTitle, enableTBPDETDgination, respAnTBPDETDyloadFields, fileFields, modelName, filterField
from .doc import doc
...
class List(Resource):
    ...
    if 'parent_id' in respAnTBPDETDyloadFields:
    ...
    @token_required
    def get(self):
        return GeneralGetList(doc, crudTitle, enableTBPDETDgination, respAnTBPDETDyloadFields, Service, parser)
