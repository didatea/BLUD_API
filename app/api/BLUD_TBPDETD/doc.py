...
from . import apiName, apiPath, crudTitle, docName, respAnTBPDETDyloadFields, enableTBPDETDgination
...
class doc:
    ...
    default_data_response = api.model(
        f"{docName}_object", respAnTBPDETDyloadFields
    )
    ...
    getRespDoc = generateDefaultDoc(api, default_data_response, crudTitle, "get-list-pagination" if enableTBPDETDgination == True else "get-list", docName)
