...
from app import db
from . import searchField, uniqueField, sortField, crudTitle, respAnTBPDETDyloadFields, modelName, filterField
from .doc import doc
...
class Service:
    ...
    @staticmethod
    def getDataAll(args):
        return GeneralGetDataAll(respAnTBPDETDyloadFields, model, current_app, args, filterField)

    @staticmethod
    def getDataServerSide(args):
        return GeneralGetDataServerSide(model, searchField, respAnTBPDETDyloadFields, sortField, db, current_app, args, filterField)
