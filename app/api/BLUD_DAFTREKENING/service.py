...
from .model import DAFTREKENING
...
class Service:
    ...
    @staticmethod
    def getDataAll(args):
        return GeneralGetDataAll(respAndPayloadFields, model, current_app, args, filterField, sortField=sortField, searchField=searchField)
