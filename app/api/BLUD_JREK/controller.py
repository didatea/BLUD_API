...
class List(Resource):
    ...
    def get(self):
        ...
        # data = JREK.query.all()  # Anggap Service adalah model SQLAlchemy Anda
        #
        # # Ubah data sebelum mengembalikannya
        # data_transformasi = []
        # for item in data:
        #     item_transformasi = {
        #         'id': item.JNSREK,  # Anggap JNSREK adalah ID
        #         'URAIAN': item.URAIAN  # Anggap URAIAN adalah kolom lain
        #         # Tambahkan kolom lain jika diperlukan
        #     }
        #     data_transformasi.append(item_transformasi)

        # Kembalikan data yang telah diubah
        # return jsonify(data_transformasi)
