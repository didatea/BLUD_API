...
from app import db
from . import searchField, uniqueField, sortField, crudTitle, respAnSPPBAyloadFields, modelName, filterField
from .doc import doc
...
class Service:
    ...
    @staticmethod
    def getDataAll(args):
        return GeneralGetDataAll(respAnSPPBAyloadFields, model, current_app, args, filterField)

    @staticmethod
    def getDataServerSide(args):
        return GeneralGetDataServerSide(model, searchField, respAnSPPBAyloadFields, sortField, db, current_app, args, filterField)
