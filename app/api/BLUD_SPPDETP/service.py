...
from app import db
from . import searchField, uniqueField, sortField, crudTitle, respAnSPPDETPyloadFields, modelName, filterField
from .doc import doc
...
class Service:
    ...
    @staticmethod
    def getDataAll(args):
        return GeneralGetDataAll(respAnSPPDETPyloadFields, model, current_app, args, filterField)

    @staticmethod
    def getDataServerSide(args):
        return GeneralGetDataServerSide(model, searchField, respAnSPPDETPyloadFields, sortField, db, current_app, args, filterField)
