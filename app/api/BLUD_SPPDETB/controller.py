...
from . import crudTitle, enableSPPDETBgination, respAnSPPDETByloadFields, fileFields, modelName, filterField
from .doc import doc
...
class List(Resource):
    ...
    if 'parent_id' in respAnSPPDETByloadFields:
    ...
    @token_required
    def get(self):
        return GeneralGetList(doc, crudTitle, enableSPPDETBgination, respAnSPPDETByloadFields, Service, parser)
