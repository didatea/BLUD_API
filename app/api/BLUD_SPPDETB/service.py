...
from app import db
from . import searchField, uniqueField, sortField, crudTitle, respAnSPPDETByloadFields, modelName, filterField
from .doc import doc
...
class Service:
    ...
    @staticmethod
    def getDataAll(args):
        return GeneralGetDataAll(respAnSPPDETByloadFields, model, current_app, args, filterField)

    @staticmethod
    def getDataServerSide(args):
        return GeneralGetDataServerSide(model, searchField, respAnSPPDETByloadFields, sortField, db, current_app, args, filterField)
