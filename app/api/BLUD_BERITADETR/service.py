...
from app import db
from . import searchField, uniqueField, sortField, crudTitle, respAnBERITADETRyloadFields, modelName, filterField
from .doc import doc
...
class Service:
    ...
    @staticmethod
    def getDataAll(args):
        return GeneralGetDataAll(respAnBERITADETRyloadFields, model, current_app, args, filterField)

    @staticmethod
    def getDataServerSide(args):
        return GeneralGetDataServerSide(model, searchField, respAnBERITADETRyloadFields, sortField, db, current_app, args, filterField)
